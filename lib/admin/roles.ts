...
export const ROUTE_PERMISSIONS: Record<string, AdminRole> = {
  ...
  "GET:/api/admin/growth-opportunities": "viewer",
  "GET:/api/admin/growth-signal-intelligence": "viewer",
  ...
  "GET:/api/admin/explanations": "viewer",
  "GET:/api/admin/path-intelligence": "viewer",
  "GET:/api/admin/intelligence": "viewer",
  "GET:/api/admin/optimization-intelligence": "viewer",
  "GET:/api/admin/network-strategy-intelligence": "viewer",
  "GET:/api/admin/resilience-intelligence": "viewer",
  "GET:/api/admin/command": "viewer",
  "GET:/api/admin/decision-intelligence": "viewer",
  "GET:/api/admin/knowledge": "viewer",
  "GET:/api/admin/lifecycle-intelligence": "viewer",
  "GET:/api/admin/graph": "viewer",
  "GET:/api/admin/simulations": "viewer",
  ...
  "GET:/api/admin/strategy-intelligence": "viewer",
  "GET:/api/admin/question-lifecycle": "viewer",
  "GET:/api/admin/experiments": "viewer",
  "GET:/api/admin/experiment-strategy": "viewer",
  "GET:/api/admin/benchmarks": "viewer",
  "GET:/api/admin/os": "viewer",
  "GET:/api/admin/metric-impact": "viewer",
  "GET:/api/admin/metric-lineage": "viewer",
  "GET:/api/admin/metric-status": "viewer",
  "GET:/api/admin/release-impact": "viewer",
  "GET:/api/admin/tech-intelligence": "viewer",
