...
import { KNOWN_ARCHETYPES, toArchetypeSlug, type ArchetypeName } from "@/lib/report/archetypeSlug";

/**
 * All Reports purchase confirmation — Variant B (Figma node 5490-252).
 * Empathy framing: "Not just who you are. Everyone you've tried to understand."
 * Pair with `reportAllEmail` (variant A) for an A/B test on Stripe success.
 */
...
export interface ReportAllBEmailParams {
...
export function reportAllBEmail({ firstName, reportUrl, siteUrl }: ReportAllBEmailParams) {
  ...
  const previewText =
    "Your archetype library is ready. Most people find two or three that feel uncomfortably accurate.";
  ...
  <tr>
    <td style="padding:24px 32px 8px;">
      <h1 style="margin:0; font-family:${EMAIL_FONT}; font-size:26px; font-weight:600; line-height:1.35; color:#000000; letter-spacing:-0.3px;">
        Not just who you are. Everyone you&rsquo;ve tried to understand.
      </h1>
    </td>
  </tr>
  <tr>
    <td style="padding:16px 32px 0;">
      ...
      <p style="margin:0 0 24px 0; font-family:${EMAIL_FONT}; font-size:17px; line-height:1.55; color:#000000;">
        Inside, you&rsquo;ll find <strong style="font-weight:700;">all 14 archetype reports</strong> &mdash; <strong style="font-weight:700;">your own profile in full</strong>, alongside the psychology behind every relational pattern you&rsquo;ve encountered. <strong style="font-weight:700;">Most people find at least two or three that feel uncomfortably accurate.</strong>
      </p>
    </td>
  </tr>
  <tr>
  ...
  const text = [
    ...
    "",
    "Inside, you'll find all 14 archetype reports — your own profile in full, alongside the psychology behind every relational pattern you've encountered. Most people find at least two or three that feel uncomfortably accurate.",
    "",
    "Below are your reports:",
    "",
    archetypesText,
