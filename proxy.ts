...
export async function proxy(request: NextRequest) {
  ...
  const cspHeader = [
    ...
    "img-src 'self' data: blob: https://images.unsplash.com https://www.google-analytics.com https://www.googletagmanager.com https://cdn-cookieyes.com https://flagcdn.com",
    "media-src 'self'",
