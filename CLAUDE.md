...
| `STRIPE_COUPON_75`                        | No           | **Unused as of pricing 2.0** — no code path reads it (the 30h/54h discount ladder it served was retired). Kept documented only so a stale Vercel value is recognised as dead rather than mistaken for a live tier. Safe to delete from the env.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
