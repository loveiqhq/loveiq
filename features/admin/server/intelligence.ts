...
import type { ConversionLeakDebuggerSnapshot } from "@features/admin/server/conversion-leak-debugger";
...
import type { ForecastSnapshot } from "@features/admin/server/forecasting";
...
import type { ProductAdoptionSnapshot } from "@features/admin/server/product-adoption";
import { buildProductAdoptionSnapshot } from "@features/admin/server/product-adoption";
import type { ProductExperienceHealthSnapshot } from "@features/admin/server/product-experience-health";
...
import type { ProductIssueRadarSnapshot } from "@features/admin/server/product-issue-types";
import type { RecoveryPlaybookSnapshot } from "@features/admin/server/recovery-playbook";
import { buildRecoveryPlaybookSnapshot } from "@features/admin/server/recovery-playbook";
import type { ResearchIntelligenceSnapshot } from "@features/admin/server/research-intelligence";
import { buildResearchIntelligenceSnapshot } from "@features/admin/server/research-intelligence";
import type { StrategyPlanningSnapshot } from "@features/admin/server/strategy-planning";
...
import type { ValueRealizationSnapshot } from "@features/admin/server/value-realization";
...
import {
  ...
  summarizeItems,
  surfacePrompts,
} from "@features/admin/server/intelligence/helpers";
