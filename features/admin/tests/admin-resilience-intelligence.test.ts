...
vi.mock("@features/admin/server/resilience-intelligence", async () => {
  const actual = await vi.importActual<
    typeof import("@features/admin/server/resilience-intelligence")
  >("@features/admin/server/resilience-intelligence");
  return {
    ...actual,
