...
vi.mock("@features/admin/server/explanations", async () => {
  const actual = await vi.importActual<typeof import("@features/admin/server/explanations")>(
    "@features/admin/server/explanations"
  );
  return {
    ...actual,
