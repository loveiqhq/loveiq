...
vi.mock("@features/admin/server/knowledge", async () => {
  const actual = await vi.importActual<typeof import("@features/admin/server/knowledge")>(
    "@features/admin/server/knowledge"
  );
  return {
    ...actual,
