...
import { DELETE } from "@/app/api/admin/annotations/[id]/route";

const makeParams = (id: string) => ({ params: Promise.resolve({ id }) });
const makeReq = () => new Request("http://localhost/api/admin/annotations/1", { method: "DELETE" });

describe("admin annotations/[id] DELETE", () => {
  beforeEach(() => {
    vi.clearAllMocks();
