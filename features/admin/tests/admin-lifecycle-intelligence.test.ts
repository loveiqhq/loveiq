...
vi.mock("@features/admin/server/lifecycle-intelligence", async () => {
  const actual = await vi.importActual<
    typeof import("@features/admin/server/lifecycle-intelligence")
  >("@features/admin/server/lifecycle-intelligence");
  return {
    ...actual,
...
describe("GET /api/admin/lifecycle-intelligence", () => {
  ...
  it("returns 429 when rate-limited", async () => {
    ...
    expect(mockBuildLifecycleIntelligenceSnapshot).not.toHaveBeenCalled();
  });
});
