...
vi.mock("@features/admin/server/growth-opportunities", async () => {
  const actual = await vi.importActual<
    typeof import("@features/admin/server/growth-opportunities")
  >("@features/admin/server/growth-opportunities");
  return {
    ...actual,
