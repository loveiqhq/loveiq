...
vi.mock("@features/admin/server/simulations", async () => {
  const actual = await vi.importActual<typeof import("@features/admin/server/simulations")>(
    "@features/admin/server/simulations"
  );
  return {
    ...actual,
