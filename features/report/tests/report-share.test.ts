...
vi.mock("@features/report/server/planAccess", async () => {
  const actual = await vi.importActual<typeof import("@features/report/server/planAccess")>(
    "@features/report/server/planAccess"
  );
  return {
    ...actual,
