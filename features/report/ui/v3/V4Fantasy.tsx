 ...
 *
 * In 304:290's own order, flush: the intro (one text node, with a heading inside),
 * a 44px space, the fantasy table, another 44px space, and "Common challenges". The
 * practice card follows as the body's next sibling, as 441:6168 sits after 304:281
 * in the Part VI page.
 *
 ...
 *
 * THE PAYWALLED STATE — 305:217. The intro stays sharp; the table shows its locked
 * rows; "Common challenges" sits under the full blur at full length, scrambled on
...
interface Props {
  ...
  /** Opens the paywall — from the table's locks, the blurred copy and the practice. */
  onUnlock?: () => void;
}
  ...
  return (
    <>
      ...
      >
        ...
        <div className="rv4-sep" aria-hidden="true" data-node-id="368:1925" />
