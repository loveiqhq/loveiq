...
/**
 * Social-proof section (dark / control landing variant).
 *
 * Default: the hand-curated testimonial grid + "4.9/5 Rating" + "30,000+" stat —
 * i.e. how the live landing has always looked. Trustpilot replaces it ONLY once
 * the master switch is flipped (isTrustpilotEnabled), which stays off until we
 * have enough reviews. Keeping the curated grid as the default means the control
 * arm of the landing A/B is unchanged ("how it used to be").
 */
...
const S15Testimonials: FC = () => {
  // Trustpilot is parked until we have enough reviews (master switch off by
  // default). Until then the dark landing keeps its original curated grid.
  ...
  return (
    <section className="section-shell relative bg-[#0A0510] px-4">
      <div className="content-shell relative flex flex-col items-center">
        {/* Closing " — bottom-right corner of the right card */}
        <span
          aria-hidden
