  ...
  return (
    <section className="overflow-hidden bg-white pb-16 pt-4 lg:py-24">
      ...
      <div className="mt-20 flex items-center justify-center gap-4 sm:mt-16 sm:gap-6">
        ...
        {/* No row gap: the spacing lives inside each button as padding, so the tap
            targets reach 24px without overlapping (WCAG 2.2 target-size). Carried
            over from the current arm — an accessibility fix, not a design change,
