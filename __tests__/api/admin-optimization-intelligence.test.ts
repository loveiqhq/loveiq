...
vi.mock("../../lib/admin/optimization-intelligence", async () => {
  const actual = await vi.importActual<typeof import("../../lib/admin/optimization-intelligence")>(
    "../../lib/admin/optimization-intelligence"
  );
  return {
    ...actual,
