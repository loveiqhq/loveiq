...
vi.mock("../../lib/admin/decision-intelligence", async () => {
  const actual = await vi.importActual<typeof import("../../lib/admin/decision-intelligence")>(
    "../../lib/admin/decision-intelligence"
  );
  return {
    ...actual,
