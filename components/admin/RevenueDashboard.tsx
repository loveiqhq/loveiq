...
import RevenueOverviewTab from "@/components/admin/revenue-tabs/RevenueOverviewTab";
import TransactionsTab from "@/components/admin/revenue-tabs/TransactionsTab";
import FailureAnalysisTab from "@/components/admin/revenue-tabs/FailureAnalysisTab";
