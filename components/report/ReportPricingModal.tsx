...
const pricingCards: PricingCard[] = [
  {
    ...
    features: [
      "Includes the first orientation chapters",
      "Core desire drivers",
      "Initial growth paths",
      "Share report with 1 extra email",
    ],
    plan: "essentials",
    price: "EUR 14.99",
    priceSuffix: "one off",
  ...
  },
  {
    ...
    features: [
      ...
      "All sections unlocked instantly",
      "18 analysed dimensions",
      "Share report with up to 2 emails",
    ],
    plan: "full_report",
    price: "EUR 29.99",
    priceSuffix: "one off",
    strikePrice: "EUR 59.00",
    title: "Full report",
    tone: "highlight",
  },
  {
    ...
    features: [
      "All 14 archetypes unlocked",
      "All benefits from the full report",
      "Perfect for comparison across patterns",
    ],
    plan: "all_reports",
    price: "EUR 129.99",
    priceSuffix: "one off",
    strikePrice: "EUR 190.00",
    title: "All reports",
  },
];
...
function PricingMethodMark({
  ...
  return (
    <span
      className={[
        "report-pricing-modal__payment-mark",
...
const ReportPricingModal: FC<Props> = ({ archetype, open, onClose, onUnlock, returnFocusRef }) => {
  ...
  const subtitle = `Unlock your complete ${archetype} report with deeper coverage of your probabilities, sexual stage, attachment style, desire drivers, and growth paths.`;
                    ...
                    <li key={feature}>
                      <span className="report-pricing-card__feature-icon" aria-hidden="true">
                        <svg
                          ...
                          strokeWidth="1.6"
                        >
                          <path d="m4 8 2.35 2.35L12 4.7" strokeLinecap="round" />
                        </svg>
                      </span>
                      <span>{feature}</span>
                    </li>
