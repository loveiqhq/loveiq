...
| `/api/price`                          | `GET, POST` | `GET` returns the dynamic price quote(s) for a viewer's session. `POST` arms that reader's urgency window — the three minutes after which every plan costs EUR 2 more (`report_urgency_surcharge_enabled`); idempotent, and never extended once set. CSRF-guarded so a link unfurling in a chat app cannot start someone's clock.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
