...
| `/api/mcp`                            | `POST`      | The company-brain corpus as an MCP server (JSON-RPC 2.0 over HTTP), so Claude itself can search it. Tools: `search_company_context`, `get_business_numbers`, `list_sources`. Auth: `Authorization: Bearer $LOVEIQ_MCP_TOKEN`; 503 while that is unset, 401 on a bad token, rate limited to 120/min. Read-only — it never writes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
