...
| `docs/admin/domains/command-center.md` | Command-center domain map                  | Shell, leadership surfaces, org, tags, tools               | `app/admin/**`, `app/api/admin/{os,command,actions,org,lead,goals,views,tags,changelog}/**`, `features/admin/ui/**`, `features/admin/server/{os,knowledge,graph,workflow-tags}.ts` | `CODEOWNERS` |
...
| `docs/admin/domains/scoring.md`        | Scoring domain map                         | Scoring, archetypes, stats, reports, product KPIs          | `app/admin/{archetypes,scoring,reports,product-kpis,…}/**`, `features/admin/server/**`, `features/admin/ui/**`                                                                     | `CODEOWNERS` |
| `docs/admin/domains/growth.md`         | Growth domain map                          | Funnels, growth loops, journey, replay, retention, revenue | `app/admin/{funnels,growth,journey,replay,retention,revenue,…}/**`, `app/api/admin/**`, `features/admin/{ui,server}/**`                                                            | `CODEOWNERS` |
| `docs/admin/domains/research.md`       | Research domain map                        | Research repository, strategy, experiments, intelligence   | `app/admin/{research,strategy,experiments,predictions,benchmarks}/**`, `app/api/admin/**`, `features/admin/{ui,server}/**`                                                         | `CODEOWNERS` |
| `docs/admin/domains/health.md`         | Health domain map                          | Health, alerts, audit, review, release impact, access risk | `app/admin/{health,tools,activity}/**`, `app/api/admin/**`, `features/admin/{ui,server}/**`                                                                                        | `CODEOWNERS` |
