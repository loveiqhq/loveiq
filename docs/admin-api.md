...
| Route                                           | Methods              | Minimum access                                          | Source                                                                                                                      |
| ----------------------------------------------- | -------------------- | ------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| `/api/admin/ab-overview`                        | `GET`                | `viewer+`                                               | [`app/api/admin/ab-overview/route.ts`](../app/api/admin/ab-overview/route.ts)                                               |
...
| `/api/admin/analytics/email-position-ab`   | `GET`               | `viewer+`                         | [`app/api/admin/analytics/email-position-ab/route.ts`](../app/api/admin/analytics/email-position-ab/route.ts)     |
...
| `/api/admin/explorer`                      | `GET`               | `viewer+`                         | [`app/api/admin/explorer/route.ts`](../app/api/admin/explorer/route.ts)                                           |
...
| `/api/admin/funnels/landing-variant`       | `GET`               | `viewer+`                         | [`app/api/admin/funnels/landing-variant/route.ts`](../app/api/admin/funnels/landing-variant/route.ts)             |
...
| `/api/admin/journey/flow`                  | `GET`               | `viewer+`                         | [`app/api/admin/journey/flow/route.ts`](../app/api/admin/journey/flow/route.ts)                                   |
