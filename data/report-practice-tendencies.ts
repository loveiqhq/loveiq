...
export const reportPracticeTendencies: Record<string, ReportPracticeTendencyContent> = {
  "Sensual Connector": {
    introBlocks: [
      ...
      "<p>This means your actual desires, boundaries, and experiences may align with, differ from, or evolve beyond these patterns — sometimes significantly. We present two separate metrics on a 10-point scale.</p>",
      "<p><strong>Fantasy Pull</strong></p>",
      "<p><em>How strongly a theme tends to appear in imagination, curiosity, or arousal.</em></p>",
      ...
      "<p><em>How likely the same theme is to feel grounding, pleasurable, and genuinely good when experienced in real life.</em></p>",
      ...
      "<h3>How to read combinations of scores</h3>",
