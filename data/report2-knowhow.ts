...
/**
 * The educational expander for this chapter.
 *
 * Mark, 2026-08-27: "Lets add an educational piece to this section. What parts of
 * the Google Doc around Arousal, Desire and Pleasure could we copy paste into it?
 * Build it with your best choice."
 *
 * The choice is arousal non-concordance, from the paragraphs of chapter 20 the open
 * section does not use: the laboratory findings, the line that names what they show,
 * and the evolutionary reason. It is the chapter's hardest idea and the one a reader
 * is most likely to need explained, which is what an expander is for.
 *
 ...
 * belongs in the open section, not folded behind a "read the full explanation" - a
 * reader who needs it should not have to click. `KNOWHOW_VERDICT`, the line it
