...
--
-- Dropoff counts only TERMINAL abandons: abandon events where
-- no later event exists for that session. This prevents
-- tab-switches (visibilitychange) from inflating dropoff numbers.
-- =============================================================
...
BEGIN
  WITH terminal_abandons AS (
    -- Find abandon events that are the last event for their session
